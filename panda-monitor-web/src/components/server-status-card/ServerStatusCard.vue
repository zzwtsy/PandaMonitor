    ...
    <CardContent>
      ...
      <div class="grid gap-1.5 text-sm">
        <div class="flex items-center gap-1.5">
          ...
          <div class="w-14 text-right mr-1.5">网络</div>
          <div class="flex flex-1 h-4 items-center">
      ...
      <div class="grid gap-1.5 text-sm">
        <div class="flex items-center gap-1.5">
          ...
          <div class="w-14 text-right mr-1.5">流量</div>
          <div class="flex flex-1 h-4 items-center justify-between">
            <div class="flex flex-1 items-center">
              <CircleArrowUpIcon class="w-4 h-4" />
      ...
      <div class="grid gap-1.5 text-sm">
        <div class="flex items-center gap-1.5">
          ...
          <div class="w-14 text-right mr-1.5">负载</div>
      ...
      <div class="grid gap-1.5 text-sm">
        <div class="flex items-center gap-1.5">
          ...
          <div class="w-14 text-right mr-1.5">在线</div>
          <div class="flex flex-1 w-full h-4 items-center">
            {{ state.uptime }}
          </div>
        </div>
